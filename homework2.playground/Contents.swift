...
for index in 1 ..< 4 {
    ...
    tempMin: Double(arc4random() % 30) + kelvinZero, //випадкове значення температури у Кельвінах
    tempMax: Double(arc4random() % 30) + kelvinZero//випадкове значення температури у Кельвінах
    )
